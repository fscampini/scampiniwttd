...
class TalkModelTest(TestCase):
    def setUp(self):
        self.talk = Talk.objects.create(title=u'Introdução ao Django', description=u'Descrição da palestra.', 
                                        start_time='10:00')
    ...
    def test_speakers(self):
        ...
        self.talk.speakers.create(name='Felipe Scampini',
...
class CourseModelTest(TestCase):
    ...
    def test_speakers(self):
        ...
        self.course.speakers.create(name='Felipe Scampini', slug='felipe-scampini',
                                    url='http://fscamini.net')
