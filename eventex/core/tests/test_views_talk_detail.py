...
class TalkDetailTest(TestCase):
    def setUp(self):
        ...
        t.speakers.create(name='Felipe Scampini', slug='felipe-scampini')
    ...
    def test_html(self):
        ...
        self.assertContains(self.resp, '/palestrantes/felipe-scampini/')
        self.assertContains(self.resp, 'Felipe Scampini')